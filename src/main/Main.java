...
public class Main implements Runnable {
	...
	private Mesh airplaneModel = ModelLoader.loadModel("resources/models/6/airplane_v2_L2.123c71795678-4b63-46c4-b2c6-549c45f4c806/my.obj", "resources/models/6/airplane_v2_L2.123c71795678-4b63-46c4-b2c6-549c45f4c806/airplane_body_diffuse_v1_my.jpg");
	private Mesh barnModel = ModelLoader.loadModel("resources/models/saray/my/saray.obj", "resources/models/saray/my/cottage_diffuse.png");
	private Mesh houseModel = ModelLoader.loadModel("resources/models/2/45-cottage_free_other/Cottage_FREE.3DS", "resources/models/2/82-textures_cottage_dirt/Cottage_Dirt/Cottage_Dirt_Base_Color.png");
	private Mesh skyBoxModel = ModelLoader.loadModel("resources/models/skybox/untitled.obj", "resources/models/skybox/3.png");
	private Mesh dodecaedrModel = ModelLoader.loadModel("resources/models/dodecaedr/dod.obj", "resources/models/dodecaedr/dod.jpg");
	private GameObject airplane = new GameObject(new Vector3f(-97f, -460f, -3.3f), new Vector3f(0, 0, 0), new Vector3f(0.1f, 0.1f, 0.1f), airplaneModel);
	private GameObject barn = new GameObject(new Vector3f(30f, 10.5f, 7f), new Vector3f(1.54f, -0.08f, 0), new Vector3f(2f, 2f, 2f), barnModel);
	private GameObject house = new GameObject(new Vector3f(36.2f, -64.2f, 6.55f), new Vector3f(1.57f, 0, 0), new Vector3f(0.05f, 0.05f, 0.05f), houseModel);
	private GameObject skyBox = new GameObject(new Vector3f(0, 0, 0), new Vector3f(0,0,0), new Vector3f(1000f, 1000f, 1000f), skyBoxModel);
	private GameObject dodecaedr = new GameObject(new Vector3f(50, 50, 4), new Vector3f(0,0,0), new Vector3f(1f, 1f, 1f), dodecaedrModel);
...
//		glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
	...
	private void update() {
		...
		System.out.println("x "+ airplane.getPosition().x);
		System.out.println("y "+ airplane.getPosition().y);
		System.out.println("z "+ airplane.getPosition().z);


//		object.getPosition().x += speed;
//		object.getRotation().x += speed;
//		if (object.getPosition().x >= 4){
//			object.getPosition().x = -1.5f;
//        }
